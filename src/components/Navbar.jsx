...
export default function Navbar() {
  ...
  return (
    <div className={`w-[100vw] xs:flex xs:justify-between xs:p-3 ${toggle? 'xs:mb-[10rem]' : ''} xs:pt-[20px]`}>

    <div className='h-[80px] w-[80%]  m-[auto] flex items-center justify-between xs:block' >
        <img src='images/logo.png' alt='logo'/>
        <ul className={`${toggle? '' :'xs:hidden'}  xs:w-[100%] xs:text-center   flex items-center gap-[48px] mr-[6rem] font-[500] text-[16px] xs:block xs:mt-[20px] `}>
           <Link to = {'/signup'}>
        ...
        <div onClick={onToggle} className='xs:mr-[20px] hidden xs:block'>
