...
export default function Business() {
  return (
    <div className='min-w-[1512px]  h-[900px] flex business xs:min-w-[400px] xs:mt-[-90px]'>
...
<div className='business-row flex items-center  w-[100%] mb-[64px] xs:block '  >
  ...
  <div className='p-[64px] col business-col-2 w-[552px] h-[320px] rounded-[16px] flex flex-col gap-[10px] xs:w-[350px] xs:right-[0px]'>
    ...
    Whether it is Taxes, Pension insurances HMOs, trustfunds,
     Eazipay handle all your compliamces in one place and easily, in seconds!
    </p>
  </div>
  <div className='p-[64px] col business-col-3 w-[552px] h-[320px] rounded-[16px] flex flex-col gap-[10px] xs:right-[0px] xs:w-[350px]'>
    <h3 className='whitespace-nowrap'>Payroll in Seconds</h3>
    <p>
...
<p className='text-[20px] mr-[10rem] font-[400] text-center leading-[24px] tracking-[0.2px] xs:ml-[2rem] xs:text- xs:w-[70%] '>We are happy to answer your queries. Please, reach us at <br />
 <span className='text-red-500'>hello@myeazipay.com </span> 
     and expect our response shortly after.</p>
    </div>
    </div>
  )
}
